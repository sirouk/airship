import type { AssistantMessage, Model, Api, ToolResultMessage, UserMessage } from "../ai/types";
import { afterEach, describe, expect, it } from "vitest";
import { Agent } from "./agent";
import type { AgentEvent } from "./types";
import { calculateTool } from "./test-utils/calculate";
import {
 ...
 * Drives the Agent through the real streamSimple resolution path against the
 * scripted faux provider.
 */
