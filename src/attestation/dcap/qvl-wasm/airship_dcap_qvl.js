/* @ts-self-types="./airship_dcap_qvl.d.ts" */
 ...
 * @returns {Promise<any>}
 */
export function get_collateral(pccs_url, raw_quote) {
    const ret = wasm.get_collateral(addHeapObject(pccs_url), addHeapObject(raw_quote));
...
export function js_get_collateral(pccs_url, raw_quote) {
    const ret = wasm.js_get_collateral(addHeapObject(pccs_url), addHeapObject(raw_quote));
    return takeObject(ret);
}
 ...
 * @param {any} raw_quote
 * @param {any} quote_collateral
 * @param {any} root_ca_der
 * @param {bigint} now
 * @returns {any}
 */
export function js_verify_with_root_ca(raw_quote, quote_collateral, root_ca_der, now) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.js_verify_with_root_ca(retptr, addHeapObject(raw_quote), addHeapObject(quote_collateral), addHeapObject(root_ca_der), now);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function parse_quote(raw_quote) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.parse_quote(retptr, addHeapObject(raw_quote));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {any}
 */
export function verify_quote(raw_quote, quote_collateral, now_seconds) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.verify_quote(retptr, addHeapObject(raw_quote), addHeapObject(quote_collateral), now_seconds);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1824d93f294193e5: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_1672(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_1610);
            return addHeapObject(ret);
        },
    ...
    return {
        __proto__: null,
        "./airship_dcap_qvl_bg.js": import0,
    };
}

function __wasm_bindgen_func_elem_2889(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_2889(arg0, arg1);
}

function __wasm_bindgen_func_elem_1610(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_1610(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_1672(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_1672(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('airship_dcap_qvl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
